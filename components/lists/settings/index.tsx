    ...
    return (
        <div>
            ...
            <div className="bg-[#f0f2f5] rounded-md mx-3 mt-2 flex items-center py-1 mb-2">
                ...
                <TextField id="standard-basic" autoComplete="off" className="searchField ml-5" placeholder={'Search settings'} variant="standard" fullWidth value={searchTerm} onChange={(evt) => { setSearchTerm(evt.target.value) }} />
