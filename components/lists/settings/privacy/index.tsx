...
interface PrivacyProps {
    ...
    handleToPrivacy: (value: string) => void;
}

const Privacy: React.FC<PrivacyProps> = ({ tab, handleBack, handleToPrivacy }) => {
        ...
        <div className="h-screen w-full">
            ...
            <div className="h-[86%] w-full overflow-y-scroll custom-scroll">
                <div className="bg-white">
                    ...
                    <div className="flex justify-between items-center  px-6 py-4 border-b border-[#e9edef] cursor-pointer" onClick={()=>{handleToPrivacy('Last seen and online')}}>
                    ...
                    <div className="flex justify-between items-center  px-6 py-4 border-b border-[#e9edef] cursor-pointer" onClick={()=>{handleToPrivacy('Profile photo')}}>
                        <div className="max-w-[75%]">
                    ...
                    <div className="flex justify-between items-center  px-6 py-4 border-b border-[#e9edef] cursor-pointer"  onClick={()=>{handleToPrivacy('About')}}>
                        <div className="max-w-[75%]">
                    ...
                    <div className="flex justify-between items-center  px-6 py-4 border-b border-[#e9edef] cursor-pointer">
                ...
                <div className="bg-white">
                    ...
                    <div className="flex justify-between items-center  px-6 py-4 border-b border-[#e9edef] cursor-pointer" onClick={()=>{handleToPrivacy('Default message timer')}}>
                        <div className="max-w-[75%]">
                ...
                <div className="h-3 w-full bg-[#f0f2f5]"></div>
                <div className="bg-white">
                    <div className="flex justify-between items-center px-6 py-4 border-b border-[#e9edef] cursor-pointer" onClick={()=>{handleToPrivacy('Groups')}}>
                        <div className="max-w-[75%]">
                    ...
                    <div className="flex justify-between items-center px-6 py-4 border-b border-[#e9edef] cursor-pointer"  onClick={()=>{handleToPrivacy('Blocked contacts')}}>
                        <div className="max-w-[75%]">
                    ...
                    <div className="flex justify-between items-center px-6 py-4 border-b border-[#e9edef] cursor-pointer" onClick={()=>{handleToPrivacy('App lock')}}>
                        <div className="max-w-[75%]">
