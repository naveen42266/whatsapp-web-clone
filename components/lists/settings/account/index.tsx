...
interface AccountProps {
    ...
    handleToOpen: (value: string) => void;
}
const Account: React.FC<AccountProps> = ({ tab, handleBack, handleToOpen}) => {
    return (
        <div>
            ...
            <div className="hover:bg-[#f5f6f6] cursor-pointer" onClick={()=>{handleToOpen('Security notifications')}}>
                <div className="flex items-center px-6 py-4 gap-6">
                    <div><SecurityIcon fontSize="medium" className="text-[#54656f]" /></div>
