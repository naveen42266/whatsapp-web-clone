                ...
                <div className="bg-white">
                    ...
                    <div className="py-4 px-7 text-sm border-b border-slate-300">
                        <div className="flex items-center gap-3 text-[#54656f] pb-3">
                            <svg viewBox="0 0 24 24" height="25" width="25" fill="none"><title>e2e-message</title><path fill-rule="evenodd" clip-rule="evenodd" d="M13.1468 3H5.19245C3.43784 3 2 4.43784 2 6.19245V10.2361C2 11.9907 3.43784 13.4286 5.19245 13.4286H5.91071V16.0357L9.38734 13.4286H13.1468C14.9027 13.4286 16.3393 11.9907 16.3393 10.2361V6.19245C16.3393 4.43784 14.9027 3 13.1468 3Z" stroke="#8696A0" stroke-width="1.2" stroke-linejoin="round"></path><path d="M7.21436 15.0581V15.4505C7.21436 17.2051 8.65219 18.6429 10.4068 18.6429H14.1663L17.6429 21.2501V18.6429H18.3612C20.1158 18.6429 21.5536 17.2051 21.5536 15.4505V11.4068C21.5536 9.65219 20.1158 8.21436 18.3612 8.21436H16.3394" stroke="#8696A0" stroke-width="1.2" stroke-linejoin="round"></path></svg>
                        ...
                        <div className="flex items-center gap-3 text-[#54656f] pb-3">
                            <svg viewBox="0 0 24 24" height="25" width="25" color="#8696A0"><title>location-outline</title><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3.85C15.2628 3.85 17.9 6.48723 17.9 9.75C17.9 11.2005 17.2341 12.9144 16.1692 14.6727C15.1244 16.3979 13.8026 17.9926 12.7293 19.1643C12.3206 19.6104 11.6795 19.6104 11.2707 19.1643C10.1975 17.9926 8.87559 16.3979 7.83078 14.6727C6.7659 12.9144 6.1 11.2005 6.1 9.75C6.1 6.48723 8.73723 3.85 12 3.85ZM12 2.25C16.1464 2.25 19.5 5.60357 19.5 9.75C19.5 13.5199 16.1311 17.8193 13.9091 20.245C12.8662 21.3835 11.1338 21.3835 10.0909 20.245C7.86889 17.8193 4.50001 13.5199 4.5 9.75C4.5 5.60357 7.85357 2.25 12 2.25ZM12 13.6C13.9192 13.6 15.475 12.0442 15.475 10.125C15.475 8.20581 13.9192 6.65 12 6.65C10.0808 6.65 8.525 8.20581 8.525 10.125C8.525 12.0442 10.0808 13.6 12 13.6ZM13.875 10.125C13.875 11.1605 13.0355 12 12 12C10.9645 12 10.125 11.1605 10.125 10.125C10.125 9.08947 10.9645 8.25 12 8.25C13.0355 8.25 13.875 9.08947 13.875 10.125Z" fill="currentColor"></path></svg>
                            <div>Location sharing</div>
                        </div>
                        <div className="flex items-center gap-3 text-[#54656f] pb-3">
                            <svg viewBox="0 0 24 24" height="25" width="25" fill="none"><title>e2e-status</title><path d="M20.3351 11.583C20.4874 15.1659 18.3165 18.5828 14.7619 19.8518C14.3677 19.9923 13.9702 20.102 13.5718 20.1813" stroke="#8696A0" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5.61426 6.39954C6.52735 5.35496 7.71219 4.52266 9.11157 4.02283C11.6343 3.12242 14.3025 3.50061 16.408 4.82167" stroke="#8696A0" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10.3036 20.1821C7.50086 19.624 5.05315 17.6498 4.02262 14.7625C3.35894 12.9029 3.3898 10.9646 3.98122 9.23047" stroke="#8696A0" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path><path d="M17.2768 11.9373C17.2768 14.8864 14.886 17.2769 11.937 17.2769C8.98793 17.2769 6.59717 14.8864 6.59717 11.9373C6.59717 8.98828 8.98793 6.59778 11.937 6.59778C12.9754 6.59778 13.9446 6.89418 14.7646 7.40699" stroke="#8696A0" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path></svg>
