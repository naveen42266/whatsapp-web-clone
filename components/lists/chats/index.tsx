        ...
        <div className="h-screen w-full relative">
            <div className="sticky top-0 bg-white">
                ...
                <div className="bg-[#f0f2f5] rounded-md mx-3 mt-2 flex items-center py-1">
                    ...
                    <TextField id="standard-basic" autoComplete="off" className="searchField ml-5" placeholder={isFocused ? '' : handlePlaceholder()} variant="standard" fullWidth value={searchTerm} onChange={(evt) => { setSearchTerm(evt.target.value) }} onFocus={handleFocus} onBlur={handleBlur} inputRef={inputRef} />
