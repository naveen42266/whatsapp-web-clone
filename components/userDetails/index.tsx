...
const UserDetails = () => {
    ...
    function handleUserDetails() {
        setWhatsapp({ ...whatsapp, userProfile: false });
    }
    return (
        <div className="bg-white h-full">
            ...
            <div className="h-[91%] w-full overflow-y-scroll custom-scroll">
                <div className="py-7 flex flex-col justify-center items-center">
                    ...
                    <div className='text-xl pt-3'>Name</div>
                    <div className='text-base text-[#8696a0]'>+91 99999 99999</div>
                </div>
                ...
                <div className='py-3 px-7'>
                    ...
                    <div className='grid grid-cols-11 gap-2 py-3'>
                        ...
                        {[1, 2, 3]?.map((each) => {
                            return (
                                <div className='col-span-3 h-24 w-24 bg-slate-500 rounded-lg'></div>
                            )
                        })}
                    </div>
                </div>
                    ...
                    <div className='flex justify-between'>
                        <div className='flex items-center gap-2'>
                            ...
                            <div>
                                ...
                                <div className='text-base'>Messages are end-to-end encrypted. Click to verify.</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='py-3 px-7 border-t border-slate-100 hover:bg-slate-50'>
                    <div className='flex justify-between items-center'>
                        <div className='flex items-center gap-2 text-[#ea0038]'>
                            ...
                            <div className='text-base'>Block Name</div>
                        </div>
                    </div>
                </div>
                <div className='py-3 px-7 border-b border-slate-100 hover:bg-slate-50'>
                    <div className='flex justify-between items-center'>
                        <div className='flex items-center gap-2 text-[#ea0038]'>
                            ...
                            <div className='text-base'>Report Name</div>
                        </div>
                    </div>
                </div>
